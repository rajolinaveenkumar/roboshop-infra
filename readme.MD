...
```
```
mysql -h mysql-dev.naveenrajoli.site -u root -pRoboShop1 < shipping/db/app-user.sql
```
```
mysql -h mysql-dev.naveenrajoli.site -u root -pRoboShop1 < shipping/db/master-data.sql
```
